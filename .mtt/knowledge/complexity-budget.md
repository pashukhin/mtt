...
1. **Core-or-extension test.** A new capability enters the core only if it strengthens enforcement of "done" OR human legibility of the true state (the release-scope criterion). Otherwise it lives as an extension / hook / sibling tool.
