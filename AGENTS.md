...
- **Bilingual docs (English primary + Russian mirror):** `README.md` ↔ `README.ru.md`,
  ...
  `FLOW_GUIDE.md` ↔ `FLOW_GUIDE.ru.md`, `CONFIG_REFERENCE.md` ↔ `CONFIG_REFERENCE.ru.md`. English is the
  source of truth; when either changes, update both and keep them consistent.
